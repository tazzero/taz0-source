+++
title = "Cypherpunk Bitstream 0x0b: The Roots of Parallel Polis"
...
episode = 11
explicit = true
mp3 = "cdn/cypherpunk-bitstream/episodes/CypherpunkBitstream-0x0b-ParalelniPolis.mp3"
+++

We
[talk](https://cdn.anarplex.net/cdn/cypherpunk-bitstream/episodes/CypherpunkBitstream-0x0b-ParalelniPolis.mp3)
with [Martin Leskovjan](https://twitter.com/leskovjanmartin) and [Juraj Bednár](
https://juraj.bednar.io/en/juraj-bednar-2/) about the roots of [Parallel
Polis](https://en.wikipedia.org/wiki/Parallel_Polis), a socio-political concept
created by [Václav Benda](https://en.wikipedia.org/wiki/V%C3%A1clav_Benda)
in connection with [Charter 77](https://en.wikipedia.org/wiki/Charter_77).
Parallel Polis was about creating parallel societies during the Czechoslovak
Socialist Republic.

We also cover how it inspired and influenced the contemporary projects [Paralelní Polis](https://www.paralelnipolis.cz/o-nas/en/) in Prague and
[Paralelna Polis](https://paralelnapolis.sk/homepage/) in Bratislava in which
Martin and Juraj are involved.

What can we learn from the Parallel Polis concept
for contemporary freedom movements?
